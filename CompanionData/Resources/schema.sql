...
CREATE TABLE SkillModifier (
                               ...
                               FOREIGN KEY (trait_id) REFERENCES Trait(id) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE NonApplicableTrait (
                                    ...
                                    FOREIGN KEY (trait_id) REFERENCES Trait(id) ON UPDATE CASCADE ON DELETE CASCADE,
                                    FOREIGN KEY (opposite_trait_id) REFERENCES Trait(id) ON UPDATE CASCADE ON DELETE CASCADE,
